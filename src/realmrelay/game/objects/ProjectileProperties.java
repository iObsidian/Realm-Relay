...
public class ProjectileProperties {
    ...
    public ProjectileProperties(XML param1) {
        ...
        for (XML _loc2_ : param1.getChilds("ConditionEffect")) {
            ...
            this.effects.add(ConditionEffect.getConditionEffectFromName(_loc2_.name()));
        ...
        if (param1.getChild("ParticleTrail").hasOwnProperty("@intensity")) {
            this.particleTrailIntensity = param1.getChild("ParticleTrail").getIntAttribute("@intensity") * 100;
        }
        if (param1.getChild("ParticleTrail").hasOwnProperty("@lifetimeMS")) {
