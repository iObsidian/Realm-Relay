...
public class GameServerConnection {
    ...
    public void editAccountList(int accountListId, boolean param2, int param3) {
    }
    ...
    public boolean invSwap(Player player, GameObject sourceObj, int slotId1, int itemId1, GameObject targetObj, int slotId2, int itemId2) {
        return false;
    }
    ...
    public boolean invSwapPotion(Player param1, GameObject param2, int param3, int param4, GameObject param5, int param6, int param7) {
        return false;
    }
